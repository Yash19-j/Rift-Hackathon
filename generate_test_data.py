...
Designed for deployment on cloud platforms like Render.
...
OUTPUT_FILE = os.getenv("OUTPUT_FILE", "test_10k.csv")
TOTAL_ROWS = int(os.getenv("TOTAL_ROWS", "10000"))
TS_START = datetime(2024, 1, 1)
TS_END = datetime(2024, 3, 1)
AMOUNT_MIN, AMOUNT_MAX = 500, 75_000
SHOW_ANSWER_KEY = os.getenv("SHOW_ANSWER_KEY", "true").lower() == "true"
...
def generate_test_data():
    ...
    global rows, tx_counter, answer_key
    
    try:
        logger.info(f"Starting test data generation ({TOTAL_ROWS} rows)")
        
        # =====================================================================
        # 1. CYCLES OF LENGTH 3  (5 cycles × 3 accounts = CYC3_001..CYC3_015)
        # =====================================================================
        logger.info("Planting 5 cycles of length 3...")
        for i in range(5):
        ...
        # =====================================================================
        logger.info("Planting 3 cycles of length 4...")
        for i in range(3):
        ...
        # =====================================================================
        logger.info("Planting 2 cycles of length 5...")
        for i in range(2):
        ...
        # =====================================================================
        logger.info("Planting 4 fan-out hubs...")
        for i in range(4):
        ...
        # =====================================================================
        logger.info("Planting 3 fan-in collectors...")
        for i in range(3):
        ...
        # =====================================================================
        logger.info("Planting 3 shell chains (4 hops each)...")
        for i in range(3):
        ...
        # =====================================================================
        logger.info("Planting 5 legitimate merchants (60+ txns each)...")
        for i in range(5):
        ...
        # =====================================================================
        # 8. RANDOM LEGITIMATE TRANSACTIONS  (fill to total rows)
        # =====================================================================
        remaining = TOTAL_ROWS - len(rows)
        logger.info(f"Filling {remaining} random legitimate transactions...")
        ...
        logger.info(f"✅ Generated {len(rows)} transactions → {OUTPUT_FILE}")

        # =====================================================================
        # ANSWER KEY (only display if enabled)
        # =====================================================================
        if SHOW_ANSWER_KEY:
            print("\n" + "=" * 60)
            ...
            logger.info("Answer key display disabled (SHOW_ANSWER_KEY=false)")
